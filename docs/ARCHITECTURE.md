...
The system is a single application built within a **monorepo** structure, where the mobile client
handles all responsibilities previously assigned to the server.
...
To save tokens and computation we do not enter 365 journal entries, but rather 5 journal entries, 3
